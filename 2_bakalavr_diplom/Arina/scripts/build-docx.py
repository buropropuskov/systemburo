#!/usr/bin/env python3
"""
Сборка .docx файла ВКР Арины из Markdown-файлов.

Формат: ГОСТ + требования МИРЭА (бакалавриат, стартап-проект)
...
BASE_DIR = Path("/home/washka/project/diplom/Arina")
OUTPUT_PATH = BASE_DIR / "output" / "vkr_arina.docx"
...
FIGURE_MAP = {
    "1.1": "1.1_legaltech_quadrant.png",
    "2.1": "2.1_architecture_dockee.png",
    "2.2": "2.2_document_analysis_flow.png",
    "2.3": "2.3_testing_pyramid.png",
    "3.1": "3.1_cicd_pipeline.png",
}
...
class MarkdownToDocx:
    ...
    def _filter_references(self, lines):
        """Для references.md: оставляем все строки как есть, кроме заголовка."""
        result = []
        for line in lines:
            stripped = line.strip()
