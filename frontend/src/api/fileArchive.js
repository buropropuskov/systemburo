 ...
 * реестр плейсхолдеров для конструктора пути, живое превью, ручное
 * пересоздание файлов заявки, сводка вкладки «Обзор», оценка и скачивание
 * ZIP за период, бэкфилл и список реестра для вкладки «Ошибки» (срез C4).
 */
