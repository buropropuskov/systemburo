...
/* Компонент сам оформляет свою полосу между шапкой карточки и телом заявки:
   отступы по краям те же, что у шапки, поэтому полоса читается как её
   продолжение, а не как первый блок содержимого. */
.bureau-note {
    padding: 8px 20px;
