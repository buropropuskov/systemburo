...
@media (max-width: 767.98px) {
  /* Убирать рамку панели целиком владелец не просил - без неё "куда пропала
     ...
     строками, а не таблицей). Радиус 30px десктопа заменён на 15px строки талона -
     тем же контейнер и содержимое читаются одним блоком, а не «скруглённым
     внутри непонятно чего». Против «квадрата в квадрате» отвечают уже сами строки
     ниже: скругление получают только верхний край первой и нижний последней, а не
