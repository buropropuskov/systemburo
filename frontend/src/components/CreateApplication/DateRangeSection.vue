...
/* Планшет: ряд «дата - время - тумблеры» шире экрана и вылезал за правый край
   (замер на 810: документ 947 при вьюпорте 810, за краем оставались подпись
   «Дополнительно» и «Бесплатная парковка»). Разрешаем перенос - блоки встают в две
   строки, ничего не режется. */
