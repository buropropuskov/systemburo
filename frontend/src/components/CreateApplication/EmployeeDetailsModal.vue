                ...
                <div class="details-section">
                  ...
                  <div class="section-body">
                    <div class="details-grid two-columns">
                      ...
                      <!-- Отметка заявителя, что работник уведомлён об обработке его
                           данных: показываем дату, когда отметка есть. У записей,
    ...
    this.showAddBlacklist = false;
        ...
        async exportHistory() {
            ...
            try {
                ...
                const fullName = [this.employee?.last_name, this.employee?.first_name, this.employee?.middle_name]
                    .filter(Boolean).join('_').replace(/[^\wа-яА-ЯёЁ-]+/gu, '_') || 'sotrudnik';
