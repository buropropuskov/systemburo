<template>
  ...
  >
    ...
    <!-- Уведомление субъекта об обработке его персональных данных (часть 3 статьи 18
         152-ФЗ). Данные вводит заявитель, а не сам человек, поэтому закон требует не
         согласия, а уведомления, и сделать это может только заявитель: бюро с человеком
         не контактирует. Отметка - свидетельство заявителя, что он это сделал. Показывается
