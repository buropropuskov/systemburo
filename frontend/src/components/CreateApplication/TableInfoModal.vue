...
/* Тот же вид, что у секций в карточках машины и сотрудника: рамка, скругление 20px,
   подложка surface-2. Своя тень здесь выбивалась из соседних окон (#2551). */
.details-section {
...
/* Фотография занимает секцию целиком - отступов по краям нет. Рамки у неё тоже нет:
   обводит и скругляет сама секция, вторая линия внутри читалась как двойная. */
.photo-body {
    padding: 0;
}
...
/* Рамки у самой фотографии нет: секция уже обведена и обрезает содержимое по своему
   скруглению, вторая линия внутри читалась как двойное скругление (#2551). */
.photo-container {
    position: relative;
    width: 100%;
    height: 200px;
