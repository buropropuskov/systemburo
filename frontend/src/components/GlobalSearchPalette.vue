...
/* Подложка строки -- --surface-2: это слой «внутри карточки» (строка, чип, поле), и он
   единственный, что ведёт себя правильно в обеих темах. Жёстко заданный светлый цвет
   здесь давал в тёмной теме светлую плашку под светлым текстом, и выделенная строка
   читалась хуже невыделенных. */
.gsp__row--active {
