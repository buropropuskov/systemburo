    ...
    <div class="content-container">
      ...
      <div class="details-column">
        ...
        >
          ...
          <!-- Разбор записи, заведённой подачей заявки (#1875). Секция даёт плашке фон
               и рамку карточки - в справочнике она обязана читаться как раздел, а не
               как чужое вкрапление из карточки заявки. -->
          <div
