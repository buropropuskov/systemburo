            ...
            <div class="details-body">
              <div class="compact-form">
                ...
                <div class="settings-section">
                  ...
                  <!-- Только для таблиц машин: строку "по факту" заявитель создаёт
                       тумблером в форме транспорта, а у сотрудников такого тумблера нет -
                       наполнять блок у таблицы людей нечем, и включённый флажок давал
                       охраннику пустой список вместо признака "заявок нет" (#2019).
                       Человека без заявки вносят кнопкой ручного добавления (#1049). -->
                  <div
                    v-if="selectedTable.table.table_type === 'cars'"
                  ...
                  >
                    ...
                    <p class="field-hint">
                      ...
                      "по факту". В ней отображаются машины, номер которых
                      заранее не известен.
                    </p>
                  </div>
