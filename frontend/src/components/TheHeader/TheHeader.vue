...
@media (max-width: 768px) {
  /* Шапка закреплена сверху при скролле - "Подать заявку" и колокольчик всегда доступны.
     ...
     Нативный fixed;top:0 прибивается композитором к верхней кромке visual viewport без JS -
     смена высоты экрана (адресная строка/клавиатура) не вызывает reflow-дёрганья. Высота
     компенсируется padding-top у #main-content. */
  .header {
    position: fixed;
    top: 0;
    left: 0;
