...
// Групповые операции над таблицами проходной (#1194 S1/S6): moved_between_tables и
// unbound_from_table не должны рендериться сырым action_type (урок #951/#1085).
describe('CarHistoryModal - лейблы групповых операций (#1194 S6)', () => {
  beforeEach(() => setActivePinia(createPinia()));

  it('moved_between_tables -> русский лейбл и dot-update', () => {
    const wrapper = mount(CarHistoryModal, {
      props: { carId: 1 },
