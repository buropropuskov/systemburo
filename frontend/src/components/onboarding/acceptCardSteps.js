...
export const acceptCardSteps = [
  ...
  },
  {
    ...
    title: 'Статус заявки',
    description:
      'Судьба заявки: «Непрочитано», «В обработке», «В работе», «Завершено», «Отказано», «Отозвана». Это не то же, что согласование: согласование - про решение людей, статус - про то, где заявка в работе бюро.',
    reveal: { open: 'first-application' },
  },
  {
  ...
  },
  {
    ...
    description:
      'Заявитель прикладывает к заявке сканы и письма - договор, гарантийное, список оборудования. Файлы видны в карточке и открываются прямо отсюда; после подачи состав файлов не меняется.',
    reveal: { open: 'first-application' },
  },
  {
    ...
    description:
      'На телефоне кнопка «Скачать» стоит в шапке карточки и открывает окно «Скачивание бланков»: заполненные бланки берутся по одному или все сразу. На компьютере она живёт в строке списка, в правой колонке. Паспортные данные участников попадают в файл только у тех, кому разрешена их выгрузка; остальным на их месте стоит прочерк.',
    reveal: { open: 'first-application' },
  },
];
