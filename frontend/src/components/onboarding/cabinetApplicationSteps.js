...
export const cabinetApplicationSteps = [
  ...
  },
  {
    ...
    description:
      'Блок «Обсуждение заявки» разворачивается по заголовку. Кнопка «Начать обсуждение» заводит новую тему, ответы собираются в тред под ней. Так уточняют детали, не звоня и не подавая заявку заново; непрочитанное помечается меткой «Новое».',
    optional: true,
    side: 'bottom',
    reveal: { open: 'first-application' },
  },
