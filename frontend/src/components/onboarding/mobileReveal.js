 ...
 * панель, нужную ТЕКУЩЕМУ шагу, и явно ДЕРЖИМ ЗАКРЫТОЙ другую: overflow-шаги
 * (`*-header-feedback`/`*-header-time`) держат drawer закрытым, а nav-группа
 * (`*-nav-*`) - overflow. Шаг «Уведомления» (`*-header-notifications`) reveal НЕ
 * несёт: колокольчик с #1097 W3.2 вынесен в саму шапку (вне "⋯") - на нём обе
 * панели закрыты, иначе рядом с подсветкой колокольчика открылось бы меню "⋯".
 *
