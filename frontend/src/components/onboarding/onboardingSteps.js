...
export const onboardingSteps = [
  ...
  },
  {
    ...
    description: 'Мы перешли в «Оформление и подачу заявки» - главное действие в системе. Слева выбираете тип пропуска (бланк): «Автомобили», «Сотрудники» или «Имущество». От выбранного бланка зависит, какие поля появятся в форме справа. В одну заявку можно добавить сразу несколько бланков.',
  },
  {
    id: 'createapp-car',
    route: '/new-application',
    element: '[data-testid="ob-app-form"]',
    title: 'Бланк «Автомобили»',
    description: 'Добавили бланк «Автомобили» - справа открылась форма для транспорта. Выберите формат номера (например «Россия»), впишите номер и марку, отметьте места разгрузки. Кнопка «Добавить» перенесёт авто в список ниже - в одну заявку можно внести несколько машин. Ниже - пример заполнения.',
    demoAttachment: 'cars',
    demo: 'carForm',
  },
  {
    ...
    route: '/new-application',
    element: '[data-testid="ob-app-form"]',
    title: 'Бланк «Сотрудники»',
    description: 'А это форма для бланка «Сотрудники»: гражданство, ФИО, должность и паспортные данные. Для иностранных граждан появятся поля патента и разрешения на работу. Кнопкой «Добавить» сотрудник попадёт в список заявки. Ниже - пример заполнения.',
