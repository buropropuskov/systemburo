...
export const onboardingSteps = [
  ...
  },
  {
    ...
    title: 'Шапка заявки',
    description: 'Добавили бланк «Автомобили» - справа открылась форма. Сверху заполняете шапку: организацию, компанию (отдел) и ответственное лицо с телефоном. Эти данные общие для всей заявки, какие бы бланки в неё ни входили.',
    demoAttachment: 'cars',
    side: 'left',
    align: 'start',
  },
  ...
  },
  {
    ...
    description: 'Сама форма транспорта: формат номера, номер и марка, места разгрузки. Кнопка «Добавить» переносит авто в список ниже - в одну заявку можно внести несколько машин.',
    demoAttachment: 'cars',
    side: 'left',
    align: 'start',
  },
  {
    ...
    description: 'Для бланка «Сотрудники» форма другая: гражданство, ФИО, должность и паспортные данные. Для иностранных граждан появятся поля патента и разрешения на работу. Кнопка «Добавить» переносит сотрудника в список заявки.',
