...
export const onboardingSteps = [
  ...
  },
  {
    ...
    description: 'Добавили бланк «Автомобили». Бланк - это раздел заявки: в него вносят один или несколько автомобилей. Бланков в заявке может быть несколько, например машины и сотрудники сразу.',
    demoAttachment: 'cars',
    side: 'right',
    align: 'start',
  },
