 ...
 *                пропускается, если она не появилась;
...
export const onboardingSteps = [
  ...
  },
  {
    ...
    description:
      'Кнопка поиска открывает панель результатов: человек, машина, заявка, раздел или действие - начните вводить, и совпадения появятся сразу. Панель открывается и с клавиатуры сочетанием Ctrl+K, её можно закрепить раскрытой или свернуть в столбик.',
    // Панель поиска открывается только по действию пользователя - раскрываем её,
    // иначе шаг рассказывал бы про окно, которого человек не видит.
  ...
  // внутри группы, и на последнем карточка закрылась бы посреди рассказа о ней.
  {
    ...
    description:
      'Открыли вашу заявку. Блок «Согласование заявки» показывает, на какой она стадии, а если у заявки есть согласующие - список «Ответственные за согласование»: у каждого свой статус и комментарий. Помеченные «Обязательно» решают судьбу заявки: без их согласия принять её в работу нельзя.',
    optional: true,
  ...
  },
  {
    ...
    route: '/new-application',
    element: '[data-testid="create-app-consent-checkbox"]',
