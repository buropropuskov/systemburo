...
export function buildSecurityFinalStep() {
  return {
    ...
    title: 'Готово!',
    description:
      'Вы освоились: смотрите согласованные бланки в разделе «Доступные мне», отмечаете въезд и выезд в таблице поста и в любой момент можете свериться с отчётом за сутки. Можно открыть «Доступные мне» прямо сейчас.',
  };
}
