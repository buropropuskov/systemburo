...
export function buildSecurityFactSteps(route) {
  ...
  return [
    ...
    },
    {
      ...
      description:
        'Кнопкой «Въезд» отмечаете, что машина заехала. Отметили не ту машину - следующие пятнадцать минут та же кнопка называется «Отменить» и снимает запись по указанной причине. Дальше отметку убирает только администратор.',
    },
    {
      id: 'sec-pass-exit',
      route,
