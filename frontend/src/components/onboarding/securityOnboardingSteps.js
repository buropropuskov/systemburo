...
export const securityOnboardingSteps = [
  ...
  },
  {
    ...
    description:
      'Здесь копятся события: заявку согласовали, начали обсуждение, срок пропуска подходит к концу. Свежие идут сверху, непрочитанные выделены, вкладки «Все» и «Непрочитанные» отбирают нужное. Пустой список значит, что нового нет. Шестерёнка ведёт к настройке уведомлений.',
    optional: true,
