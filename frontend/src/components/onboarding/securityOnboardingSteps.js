  ...
  return [
    {
      ...
      title: 'Таблица поста',
      description:
        'Это журнал вашего поста: в списке «по заявке» - машины и люди из согласованных заявок, которых сегодня ждут. Столбцы задаёт бюро пропусков, поэтому у разных постов они разные.',
    },
    {
      id: 'sec-pass-row',
      route,
    ...
    },
    {
      ...
      description:
        'Список «по факту» - для тех, кого в заявке не было: машину пропускают вручную, и запись остаётся здесь. Кнопка «Добавить вручную» вверху заводит такую запись.',
    },
    {
    ...
    },
    {
      ...
      description:
        'Кнопка «Отчёт» показывает, сколько машин заехало и выехало за смену. Смена считается с 21:30 предыдущего дня до 21:30 текущего, поэтому сразу после 21:30 счётчики пустые. Видно и то, кто сколько отметил.',
    },
  ];
}
