...
export function buildSecurityFactSteps(route) {
  ...
  return [
    ...
    },
    {
      ...
      description:
        'Кнопка «Отчёт» показывает, сколько машин заехало и выехало за сутки, которые считаются с 21:30 предыдущего дня до 21:30 текущего. Сразу после 21:30 счётчики пустые - начались новые сутки. Видно и то, кто сколько отметил.',
    },
  ];
}
