...
const pointsOf = (props) => mount(Sparkline, { props }).find('polyline').attributes('points');
...
describe('Sparkline', () => {
  ...
  it('цвет линии зависит от направления', () => {
    const up = mount(Sparkline, { props: { series: [1, 2], direction: 'up' } });
    const down = mount(Sparkline, { props: { series: [1, 2], direction: 'down' } });
