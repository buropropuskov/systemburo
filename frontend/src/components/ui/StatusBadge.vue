  ...
  computed: {
    ...
    colorClass() {
      ...
      const map = {
        ...
        yellow: ['непрочитано', 'в обработке', 'на рассмотрении', 'согласование', 'pending', 'закрыто', 'закрыто сейчас', 'на обслуживании', 'нет шаблона'],
        red: ['не согласовано', 'отклонено', 'отказано', 'rejected', 'чёрный список', 'черный список', 'ошибка выгрузки', 'заблокировано'],
