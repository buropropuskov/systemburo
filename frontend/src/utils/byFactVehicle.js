...
/**
 * Подсказка у полей даты - короткое указание, что поправить.
 *
 * Крайний срок цифрами сюда НЕ пишется: он уже стоит в панели предупреждений
 * второй строкой, а у полей от него подсказка только раздувалась вширь.
 */
export function byFactFieldHint() {
  return 'Укажите корректный срок';
}
