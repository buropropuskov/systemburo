 ...
 * даёт прочерк. Раньше форматирование было скопировано втроём (DocumentsManagement,
 * GuideManagement, UserGuideModal) с разными правилами округления - здесь единая
 * версия для нового кода, старые три ждут отдельной уборки.
 * @param {number} bytes
 * @returns {string}
 */
