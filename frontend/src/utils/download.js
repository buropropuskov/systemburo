...
/**
 * Переводит байты в привычные единицы (Б/КБ/МБ/ГБ) - тот же формат, что
 * humanBytes в cmd/server/cleanup.go, чтобы CLI-отчёт и вкладка «Файловый архив»
 * показывали одинаковые числа. Раньше форматирование было скопировано втроём
 * (DocumentsManagement, GuideManagement, UserGuideModal) с разными правилами
 * округления - здесь единая версия для нового кода.
 * @param {number} bytes
 * @returns {string}
 */
