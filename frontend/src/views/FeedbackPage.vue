...
/* Тач-устройства. Кнопка появляется по наведению на строку, а наведения там нет -
   пометить обращение важным с телефона или планшета было нельзя вовсе. Показываем
   её всегда и доводим до размера пальца.
   Условие двойное: `hover: none` ловит реальные тач-экраны любой ширины, ширина -
   узкие окна и эмуляцию (браузерная эмуляция мобильного `hover` не переключает). */
