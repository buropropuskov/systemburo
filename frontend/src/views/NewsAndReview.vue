...
export default {
  ...
  methods: {
    ...
    async fetchNews() {
      ...
      try {
        ...
        const response = await fetch('http://localhost:8080/news', { headers: { Authorization: `Bearer ${token}` } })
    ...
    async fetchAllNews() {
      try {
        const token = localStorage.getItem('token')
        const response = await fetch('http://localhost:8080/news/all', { headers: { Authorization: `Bearer ${token}` } })
    ...
    async fetchAllAnnouncements() {
      try {
        const token = localStorage.getItem('token')
        const response = await fetch('http://localhost:8080/announcements/all', { headers: { Authorization: `Bearer ${token}` } })
    ...
    async updateNews() {
      try {
        const token = localStorage.getItem('token')
        const response = await fetch(`http://localhost:8080/news/${this.editingNews.id}`, {
          method: 'PUT',
          headers: { Authorization: `Bearer ${token}`, 'Content-Type': 'application/json' },
          body: JSON.stringify(this.newsForm)
        })
    ...
    async toggleNewsActive(item) {
      try {
        const token = localStorage.getItem('token')
        const response = await fetch(`http://localhost:8080/news/${item.id}`, {
          method: 'PUT',
          headers: { Authorization: `Bearer ${token}`, 'Content-Type': 'application/json' },
    ...
    async deleteNewsItem(id) {
      ...
      try {
        const token = localStorage.getItem('token')
        const response = await fetch(`http://localhost:8080/news/${id}`, { method: 'DELETE', headers: { Authorization: `Bearer ${token}` } })
        if (response.ok) {
          await this.fetchAllNews()
          await this.fetchNews()
    ...
    async updateAnnouncement() {
      try {
        const token = localStorage.getItem('token')
        const response = await fetch(`http://localhost:8080/announcements/${this.editingAnnouncement.id}`, {
          method: 'PUT',
          headers: { Authorization: `Bearer ${token}`, 'Content-Type': 'application/json' },
          body: JSON.stringify(this.announcementForm)
        })
    ...
    async setActiveAnnouncement(id) {
      ...
      try {
        const token = localStorage.getItem('token')
        const response = await fetch('http://localhost:8080/announcements/set-active', {
          method: 'POST',
          headers: { Authorization: `Bearer ${token}`, 'Content-Type': 'application/json' },
    ...
    async deleteAnnouncement(id) {
      ...
      try {
        const token = localStorage.getItem('token')
        const response = await fetch(`http://localhost:8080/announcements/${id}`, { method: 'DELETE', headers: { Authorization: `Bearer ${token}` } })
        if (response.ok) {
          await this.fetchAllAnnouncements()
          await this.fetchActiveAnnouncement()
  ...
  mounted() {
    this.fetchAllData()
    if (this.$bus) this.$bus.on('announcement-updated', (announcement) => { this.activeAnnouncement = announcement })
  },
  beforeUnmount() { if (this.$bus) this.$bus.off('announcement-updated') }
}
</script>
