...
func AllModels() []interface{} {
	return []interface{}{
		...
		// Журнал уничтожения персональных данных (#2357). Перечень того, что было
		// уничтожено, по какому основанию и когда: после восстановления из копии по
		// нему удаления применяются заново. Без FK и вне общей уборки - он обязан
		// пережить и сами копии, и сущности, о которых в нём написано.
