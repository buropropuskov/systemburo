...
// значения не имеет. Реестры сотрудников и машин (registriesStep) идут следующими:
// они ссылаются на организации/компании/гражданства/марки/форматы, которые должны
// существовать в базе к моменту их наливки. Чёрные списки (blacklistsStep) идут
// последними из готового: похожие пары строятся от реальных записей реестров, а
// значит реестры должны быть уже наполнены. Пользователи, заявки и проходы --
// следующие срезы, их здесь пока нет.
func Steps() []Step {
	return []Step{
		organizationsStep{},
		lookupsStep{},
