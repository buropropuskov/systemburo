...
// (stagesStep) идут последними: разыгрывают переходы по уже поданным заявкам
// applicationsStep руками принимающих usersStep и согласующих, назначенных при подаче --
// и заявки, и все эти люди обязаны существовать в базе раньше. Проходы -- следующий
// срез, его здесь пока нет.
func Steps() []Step {
	return []Step{
		organizationsStep{},
		usersStep{},
