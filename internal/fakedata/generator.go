...
// наливки. Чёрные списки (blacklistsStep) идут последними из готового: похожие пары
// строятся от реальных записей реестров, а значит реестры должны быть уже наполнены.
