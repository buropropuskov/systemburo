...
// значения не имеет. Реестры сотрудников и машин (registriesStep) идут последними
// из готового: они ссылаются на организации/компании/гражданства/марки/форматы,
// которые должны существовать в базе к моменту их наливки. Пользователи, заявки и
// проходы -- следующие срезы, их здесь пока нет.
func Steps() []Step {
	return []Step{
		organizationsStep{},
		lookupsStep{},
