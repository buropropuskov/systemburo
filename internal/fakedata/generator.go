...
// (applicationsStep) идут последними: подаются от пользователей usersStep, вложениями
...
// заявку) -- каждая из этих зависимостей уже должна быть в базе. Проходы -- следующий
