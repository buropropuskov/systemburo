...
// Steps() перечисляет три готовых на сегодня среза наполнения (#1682, том 2):
// организации/компании, справочники без профиля, таблицы постов. Пользователи,
// заявки и проходы -- следующие срезы, их здесь пока нет.
