...
// Steps() перечисляет восемь готовых на сегодня срезов наполнения (#1682): организации/
// компании, справочники без профиля, таблицы постов, реестры сотрудников и машин, чёрные
// списки, пользователи, заявки, стадии обработки заявок. Проходы -- следующий срез, его
// здесь пока нет.
