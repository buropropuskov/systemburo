...
// Steps() перечисляет пять готовых на сегодня срезов наполнения (#1682):
// организации/компании, справочники без профиля, таблицы постов, реестры
// сотрудников и машин, чёрные списки. Пользователи, заявки и проходы -- следующие
// срезы, их здесь пока нет.
...
// это единственные сущности среза, которые от него зависят.
