...
// и для писем о пароле это пароль - в базе, которая по всем прочим правилам
// хранит пароли только вычислением Argon2id. Пока письмо ждёт отправки, тело
// шифрует models.EmailMessage.BeforeSave (#2351), но у отправленных и
// недоставленных стирание надёжнее шифрования: копии просто нет, и её не
// нужно ни расшифровывать, ни ждать срока хранения (MAIL_MESSAGE_RETENTION_DAYS).
//
