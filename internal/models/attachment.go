...
type UniqueAttachment struct {
	...
	// BlankImportReady - у типа есть активный шаблон со списочными привязками, то есть
	// пустой бланк можно скачать, заполнить и загрузить обратно (blank-import). Поле
	// вычисляемое, в базе его нет: без него форма показывала кнопку скачивания всегда
	// и отвечала на клик отказом 404 «Шаблон бланка не настроен».
	BlankImportReady bool `gorm:"-" json:"blank_import_ready"`
}
