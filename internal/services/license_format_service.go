...
// audit_log. Замороженная license_plate_format_histories остаётся read-only бэкапом
// до дроп-sweep (F.8) и больше не читается. Форму стережёт TestLicenseFormats_History.
