...
//
// Зеркалит authoritative-гейт видимости таблицы: состав поста
// (/cars|employees/active-for-table/:id) отдаётся по праву table.<name>.view, тем же
// ключом фронт показывает пункт таблицы в NavMenu. Значит аудитория сигнала = все, у
// кого резолвер прав подтверждает это право.
//
