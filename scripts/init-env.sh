...
# =============================================================
# Параметры, которые пока не доходят до контейнера
#
# Приложение их читает, но docker compose передаёт бэкенду ЯВНЫЙ список
# переменных (docker-compose.base.yml), и этих в нём нет. Значения ниже совпадают
# с умолчаниями кода, то есть система работает ровно так, как здесь написано,
# но правка строки ничего не изменит, пока переменную не добавят в список compose.
# =============================================================
